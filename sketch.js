...
function drawUI(gesture) {
  ...
  push();
  imageMode(CENTER);
  if (moveImages[playerChoice]) image(moveImages[playerChoice], width / 2 - 420, height * 0.45 + 40, 80, 80);
  if (moveImages[computerChoice]) image(moveImages[computerChoice], width / 2 + 420, height * 0.45 + 40, 80, 80);
  pop();
